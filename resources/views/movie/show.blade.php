    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                    ...
                    @if (count($movie['videos']['results']) > 0)
                        <div class="mt-12">
                            ...
                            x-on:click="window.location.href = url;"
                                class="flex inline-flex items-center bg-blue-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-blue-700 transition ease-in-out duration-150"
                            >
                ...
                <div class="mt-12">
                    <h2 class="text-3xl font-semibold">Featured Crew</h2>
                            ...
                            @if ($crew['profile_path'] != null)
                                <div class="mt-4">
                                    <a href="{{ route('actor.show', $crew['id']) }}">
                                            <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $crew['profile_path'] }}" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                                        </a>
                                    <div>{{ $crew['name'] }}</div>
